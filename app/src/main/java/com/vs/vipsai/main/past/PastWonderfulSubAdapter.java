...
public class PastWonderfulSubAdapter extends BaseRecyclerAdapter<SubBean> implements BaseRecyclerAdapter.OnLoadingHeaderCallBack {

//    private OSCApplication.ReadState mReadState;

    public PastWonderfulSubAdapter(Context context, int mode, Activity activity) {
        super(context, mode);
//        mReadState = OSCApplication.getReadState("sub_list");
    ...
    protected RecyclerView.ViewHolder onCreateDefaultViewHolder(ViewGroup parent, int type) {
        return new BlogViewHolder(mInflater.inflate(R.layout.item_list_sub_past_wonderful, parent, false));
    }
