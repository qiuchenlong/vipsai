...
import com.vs.vipsai.account.AccountHelper;
import com.vs.vipsai.account.base.AccountBaseActivity;
        ...
        ApiHttpClient.getDirect(tokenUrl, new TextHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, String responseString) {
                ...
                if (!TextUtils.isEmpty(responseString)) {
                    ...
                    VSApi.openLogin(VSApi.LOGIN_WECHAT, responseString, new TextHttpResponseHandler() {
