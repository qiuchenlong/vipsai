package com.vs.vipsai.widget.paymentedit;
...
public class PasswordEditText extends EditText {
    ...
    // 密码圆点的颜色
    private int mPasswordColor = Color.parseColor("#333333");// mDivisionLineColor;
    // 密码圆点的半径大小
    ...
    private void initAttributeSet(Context context, AttributeSet attrs) {
        ...
        mPasswordColor = array.getColor(R.styleable.PasswordEditText_passwordColor, mPasswordColor); //mDivisionLineColor
        array.recycle();
    }
