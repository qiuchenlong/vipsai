...
public class PasswordView extends android.support.v7.widget.AppCompatEditText {
    ...
    private Paint mBorderPaint2;     //外框画笔
    ...
    private void initView() {
        ...
        mBorderPaint2.setColor(Color.parseColor("#CDCDCD"));
        mBorderPaint2.setStyle(Paint.Style.STROKE);

        mLinePaint = new Paint();
        mLinePaint.setColor(Color.parseColor("#CDCDCD"));
    ...
    private void drawRoundRect(Canvas canvas) {
        ...
        canvas.drawRoundRect(0, 0, mWidth, mHeight, 12, 12, mBorderPaint2);
    ...
    private void drawLine(Canvas canvas) {
        for (int i = 1; i < PASSWORD_LENGTH; i++) {
            ...
            canvas.drawLine(x, mPadding, x, mHeight - mPadding, mLinePaint);
        }
    }
