...
import com.vs.vipsai.detail.fragment.ListPlayerFixturesFragment;
import com.vs.vipsai.detail.fragment.ListPlayerKnockoutFragment;
...
public class KnockoutDetailViewPagerCountOfFiveFragment extends Fragment implements TweetDetailContract.ICmnView, TweetDetailContract.IAgencyView, BasePlayerDetailActivity.onViewPagerSelectListener {
    ...
    public static KnockoutDetailViewPagerCountOfFiveFragment instantiate() {
        return new KnockoutDetailViewPagerCountOfFiveFragment();
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        if (mAdapter == null) {
            ...
            final ListPlayerKnockoutFragment mKnockoutFragment;
            mCmnViewImp = mKnockoutFragment = ListPlayerKnockoutFragment.instantiate(mOperator, this);

            final ListPlayerFixturesFragment mFixturesFragment;
            mFixturesFragment = ListPlayerFixturesFragment.instantiate(mOperator, this);

            final DetailFragment mDetailFragment;
