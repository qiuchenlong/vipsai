...
public class ListPlayerKnockoutFragment extends BaseRecyclerViewFragment<PlayerComment>
    ...
    public static ListPlayerKnockoutFragment instantiate(TweetDetailContract.Operator operator, TweetDetailContract.IAgencyView mAgencyView) { //
        ListPlayerKnockoutFragment fragment = new ListPlayerKnockoutFragment();
    ...
    protected BaseRecyclerAdapter<PlayerComment> getRecyclerAdapter() { //PlayerComment
        PlayerKnockoutAdapter adapter = new PlayerKnockoutAdapter(getContext());
