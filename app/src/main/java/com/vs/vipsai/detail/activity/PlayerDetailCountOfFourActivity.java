...
import com.vs.vipsai.detail.viewpager.PlayerDetailViewPagerCountOfFourFragment;
...
public class PlayerDetailCountOfFourActivity extends BasePlayerDetailActivity implements TweetDetailContract.Operator {


    PlayerDetailViewPagerCountOfFourFragment mPagerFrag;
...
//
//                Toast.makeText(PlayerDetailCountOfFourActivity.this, "--->" + content, Toast.LENGTH_SHORT).show();
//                mDelegation.getBottomSheet().dismiss();
//
//                if (TextUtils.isEmpty(content)) {
//                    Toast.makeText(PlayerDetailCountOfFourActivity.this, "请输入文字", Toast.LENGTH_SHORT).show();
//                    return;
//                }
////                if (!AccountHelper.isLogin()) {
...
//        mDelegation.setVisible(View.GONE);
        ...
        // viewpager fragment
        mPagerFrag = PlayerDetailViewPagerCountOfFourFragment.instantiate();
