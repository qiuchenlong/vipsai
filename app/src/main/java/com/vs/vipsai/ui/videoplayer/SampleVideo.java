package com.vs.vipsai.ui.videoplayer;
...
public class SampleVideo extends StandardGSYVideoPlayer {
    ...
    public void onSurfaceAvailable(Surface surface) {
        ...
        // 设置进度条位置
        LinearLayout ll = (LinearLayout) findViewById(R.id.layout_bottom);
        FrameLayout.LayoutParams params = (FrameLayout.LayoutParams) ll.getLayoutParams();
        int sh = (int)(TDevice.getScreenHeight() / 2) - (int)TDevice.dp2px(32) + mTextureView.getHeight() / 2 - ll.getHeight() / 2; // 屏幕高度/2 - 状态栏高度(default:32dp) + 纹理高度/2 - 自体高度/2
        params.setMargins(0, sh, 0, 0);
