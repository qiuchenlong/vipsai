...
import com.vs.vipsai.adapter.UserTweetAdapter;
...
/**
 * Author: cynid
 * Created on 3/14/18 9:32 AM
 * Description:
 */

public class PastFragment extends BaseGeneralRecyclerFragment<Tweet> implements BaseRecyclerAdapter.OnItemLongClickListener {
    //, TweetNotificationManager.TweetPubNotify
