...
public class PrivateMessageSubAdapter extends BaseRecyclerAdapter<SubBean> implements BaseRecyclerAdapter.OnLoadingHeaderCallBack {
    ...
    public PrivateMessageSubAdapter(Context context, int mode, Activity activity) {
        super(context, mode);
//        mReadState = OSCApplication.getReadState("sub_list");
    ...
    protected RecyclerView.ViewHolder onCreateDefaultViewHolder(ViewGroup parent, int type) {
        return new PrivateMessageSubAdapter.MessageViewHolder(mInflater.inflate(R.layout.item_list_sub_private_message, parent, false));
    }
