package com.vs.vipsai.tweet.activities;
...
import com.vs.vipsai.base.activities.BaseBackActivity;
import com.vs.vipsai.tweet.contract.TweetPublishContract;
...
//    }
    ...
    public static void show(Context context, View view, String defaultContent) { //, About.Share share
        ...
        show(context, location, size, defaultContent, null); //share,
    }

    @SuppressWarnings("unused")
    public static void show(Context context, boolean isLocalShare, String localImageUrl) {
        show(context, null, null, null, localImageUrl); // null,
    }


    public static void show(Context context, @Size(2) int[] viewLocationOnScreen,
                            @Size(2) int[] viewSize, String defaultContent, String localImageUrl) { //About.Share share,
