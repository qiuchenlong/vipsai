...
public class BalanceSubAdapter extends BaseRecyclerAdapter<SubBean> implements BaseRecyclerAdapter.OnLoadingHeaderCallBack {

    public BalanceSubAdapter(Context context, int mode, Activity activity) {
        super(context, mode);
//        mReadState = OSCApplication.getReadState("sub_list");
    ...
    protected RecyclerView.ViewHolder onCreateDefaultViewHolder(ViewGroup parent, int type) {
        return new BalanceSubAdapter.MessageViewHolder(mInflater.inflate(R.layout.item_list_sub_balance, parent, false));
    }

    @Override
    protected void onBindDefaultViewHolder(RecyclerView.ViewHolder holder, SubBean item, final int position) {
        BalanceSubAdapter.MessageViewHolder vh = (BalanceSubAdapter.MessageViewHolder) holder;


        vh.balanceItem.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                UIHelper.showBalanceDetail(mContext);
            }
        });
...
//        ImageView imageView;
        ...
        LinearLayout balanceItem;

        MessageViewHolder(View itemView) {
            super(itemView);


            balanceItem = itemView.findViewById(R.id.item_list_sub_balance);
