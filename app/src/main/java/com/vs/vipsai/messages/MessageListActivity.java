package com.vs.vipsai.messages;
...
import com.vs.vipsai.messages.models.DefaultUser;
import com.vs.vipsai.messages.models.MyMessage;
import com.vs.vipsai.messages.ui.ChatView;
...
import com.vipsai.imui.messages.ViewHolderController;
import com.vipsai.imui.messages.ptr.PtrHandler;
...
/**
 * Author: cynid
 * Created on 4/10/18 4:37 PM
 * Description:
 *
 * 即时聊天界面
 */

public class MessageListActivity extends BackActivity implements View.OnTouchListener,
...
//    private HeadsetDetectReceiver mReceiver;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        initPopupWindow(MessageListActivity.this);
...
//        registerReceiver(mReceiver, intentFilter);
        ...
        mChatView.setMenuClickListener(new OnMenuClickListener() {
            ...
            public boolean onSendTextMessage(CharSequence input) {
                ...
                message.setUserInfo(new DefaultUser("1", "Ironman", "R.mipmap.tmp_head"));
        ...
        ImageLoader imageLoader = new ImageLoader() {
            ...
            public void loadAvatarImage(ImageView avatarImageView, String string) {
                ...
                if (string.contains("R.drawable")) {
                    ...
                    avatarImageView.setImageResource(R.drawable.tmp_head_im); //resId
                } else {
...
//        unregisterReceiver(mReceiver);
    ...
    private void initPopupWindow(Activity context) {
        ...
        String[] titles = new String[]{"清空记录", "举报广告", "屏蔽此人"};
        int[] images = new int[]{R.mipmap.ic_trash_gray, R.mipmap.ic_trash_gray, R.mipmap.ic_blacklist_gray};
