...
public class ApiHttpClient {
    ...
    public final static String HOST = "www.oschina.net"; //"192.168.3.115"; //
    public static String API_URL = "https://www.oschina.net/%s"; //"http://192.168.3.115/%s"; //
