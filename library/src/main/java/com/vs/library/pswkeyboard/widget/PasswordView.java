package com.vs.library.pswkeyboard.widget;
...
import com.vs.library.pswkeyboard.OnPasswordInputFinish;
import com.vs.library.pswkeyboard.adapter.KeyBoardAdapter;
...
public class PasswordView extends RelativeLayout {
    ...
    public PasswordView(Context context, AttributeSet attrs) {
        ...
        txtPayType = (TextView) view.findViewById(R.id.txt_pay_type);
        txtAmount = (TextView) view.findViewById(R.id.txt_amount);
        txtFee = (TextView) view.findViewById(R.id.txt_fee);
        txtForgetPwd = (TextView) view.findViewById(R.id.txt_forgetPwd);
